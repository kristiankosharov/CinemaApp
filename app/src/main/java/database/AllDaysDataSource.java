 ...
 */
public class AllDaysDataSource {
...
//        System.out.println("Comment deleted with id: " + id);
        database.delete(MySQLiteHelper.TABLE_ALL_DAYS, MySQLiteHelper.COLUMN_ID
                + " = " + id, null);
    }
...
//        SQLiteDatabase db = helper.getWritableDatabase(); // helper is object extends SQLiteOpenHelper
        database.delete(MySQLiteHelper.TABLE_ALL_DAYS, null, null);
    }
}
